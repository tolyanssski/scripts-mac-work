...
Несмотря на то, что в проектах используются ORM-системы, миграции у нас все
ручные в виде простых SQL-файлов для Postgres.
У части проектов есть своя БД, и соответственно своя папка migrations, 
...
Если ты работаешь над таким проектом и тебе требуется сделать миграцию, но в проекте нет папки migrations, просто создай новую папку migrations и
